...
barplot(quan*100,col='springgreen2',space=0,ylab='Error rate(%)',border= NA,ylim=c(0,max_quan*100),xlab='Reads position(bp)',main='Error distribution')
...
plot(Aper*100,col='red',type = 'l',xlab='Reads position(bp)',ylab='Percent',ylim=c(0,max_per*100),xaxt="n",lty=1,lwd=1.5,main="Base distribution")
axis(1,labels=axix_txt,at=axix_at)
abline(v=num+0.5, lty=2,col='darkgray')
