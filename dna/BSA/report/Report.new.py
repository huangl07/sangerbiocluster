...
#    else:
    ...
    Step1Sh.write('cp  %s/Result_bsa/02.index-slid/pop.ED.index.png   %s/file/3.ED.index.png\n\n' %(result_dir,report_dir))
    Step1Sh.write('cp  %s/Result_bsa/04.loess/loess.index.png   %s/file/4.loess.index.png\n\n' %(result_dir,report_dir))
    Step1Sh.write('cp  %s/Result_bsa/03.Gprime/Gprime.index.png   %s/file/2.Gprime.index.png\n\n' %(result_dir,report_dir))
