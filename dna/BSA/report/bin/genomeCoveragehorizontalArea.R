...
--sample -o character the sample name
...
#add theme
p<-p+theme(strip.background=element_rect(fill="white", colour="white"), strip.text.y=element_text(angle=360, vjust=0.1),plot.title=element_text(hjust=0.5), 
