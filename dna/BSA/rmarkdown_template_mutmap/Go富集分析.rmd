...
本项目更详细的候选基因GO富集结果可查看结题文件夹目录下的：Result/data_release/04.enrich/index/GO_result/index_GOenrichment.xls（SNP-index+滑窗）、Result/data_release/04.enrich/loess/GO_result/loess_GOenrichment.xls（SNP-index+loess拟合）。
