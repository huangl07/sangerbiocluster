...
Result/data_release/04.enrich/index/KEGG_result/ED_KEGGenrichment.xls（SNP-index+滑窗）、Result/data_release/04.enrich/loess/KEGG_result/ED_KEGGenrichment.xls（SNP-index+loess拟合）。
