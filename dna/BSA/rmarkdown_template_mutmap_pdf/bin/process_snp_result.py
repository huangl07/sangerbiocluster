...
def process_snp_result(group_file: str, snp_stat: str, snp_stat_all: str, snp_stat_bsa: str) -> None:
    mix_info_dict = {}
    ...
    with open(snp_stat, "r", encoding='utf-8') as f, open(snp_stat_all, "r", encoding='utf-8') as g, open(snp_stat_bsa, "w", encoding='utf-8') as m:
        ...
        for line in islice(f, 1, None):
            ...
            if line_list[0] in list(mix_info_dict.values()):
                ...
                num_tv = line_list[11]
                ts_tv = line_list[12]
                new_line = [sample_id, num_snv, num_ts, num_tv, ts_tv, num_het, num_homo_ref]
...
parser.add_argument("-t", "--snp_stat_all", required=True)
parser.add_argument("-b", "--snp_stat_bsa", required=True)
args = vars(parser.parse_args())
process_snp_result(args["group_file"], args["snp_stat"], args["snp_stat_all"], args["snp_stat_bsa"])
