...
def process_mapping_result(all_summary_stats: str, group_file: str, bsa_align_stat: str) -> None:
    mix_info_dict = {}
    ...
    with open(all_summary_stats, "r", encoding='utf-8') as f, open(bsa_align_stat, "w", encoding='utf-8') as m:
        mapping_header_list = ["Sample ID", "Mapped Ratio(%)", "Proper Ratio(%)", "Insert Size", "Real Depth", "Coverage(%) (>=1x)", "Coverage(%) (>=4x)"]
        ...
        for line in islice(f, 1, None):
            ...
            if line_list[0] in list(mix_info_dict.values()):
                ...
                insert_size = line_list[3]
                real_depth = line_list[5]
                coverage1 = line_list[6]
                coverage4 = line_list[7]
                mapping_new_line = [sample_id, mapping_ratio, proper_ratio, insert_size, real_depth, coverage1, coverage4]
...
process_mapping_result(args["all_summary_stats"], args["group_file"], args["bsa_align_stat"])
