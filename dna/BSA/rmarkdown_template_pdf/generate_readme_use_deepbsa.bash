...
02.index_结果说明文档.txt	file	readme文件
...
06.DeepBSA_DL_结果说明文档.txt	file	readme文件
pop.DeepBSA_DL.result.xls	file	DeepBSA_DL方法统计结果文件
DeepBSA_DL.region_stat.xls	file	DeepBSA_DL方法定位区域统计表
DeepBSA_DL.all.table.xls	file	DeepBSA_DL方法定位区域位点和基因详情表
DeepBSA_DL.detail.result.xls	file	DeepBSA_DL计算详细结果表" >> $1/BSA.info.result

for i in $(cut -f1 $2);do
echo "DeepBSA_DL.$i.pdf	file	不同染色体上DeepBSA_DL方法的曼哈顿图（pdf格式）
DeepBSA_DL.$i.pdf	file	不同染色体上DeepBSA_DL方法的曼哈顿图（png格式）" >> $1/BSA.info.result
done
...
07.DeepBSA_K_结果说明文档.txt	file	readme文件
pop.DeepBSA_K.result.xls	file	DeepBSA_K方法统计结果文件
DeepBSA_K.region_stat.xls	file	DeepBSA_K方法定位区域统计表
DeepBSA_K.all.table.xls	file	DeepBSA_K方法定位区域位点和基因详情表
DeepBSA_K.detail.result.xls	file	DeepBSA_K计算详细结果表" >> $1/BSA.info.result

for i in $(cut -f1 $2);do
echo "DeepBSA_K.$i.pdf	file	不同染色体上DeepBSA_K方法的曼哈顿图（pdf格式）
DeepBSA_K.$i.pdf	file	不同染色体上DeepBSA_K方法的曼哈顿图（png格式）" >> $1/BSA.info.result
done
...
08.enrich_结果说明文档.txt	file	readme文件
...
DeepBSA_DL.anno.xls	file	DeepBSA_DL定位区域注释基因信息表
DeepBSA_K.anno.xls	file	DeepBSA_K定位区域注释基因信息表
...
DeepBSA_K_KEGGenrichment.png	file	候选区域内基因的KEGG富集统计图（png格式）
09.primer_design	folder_1	候选区域引物设计结果
09.primer_design_结果说明文档.txt	file	readme文件
...
Gprime.kasp.result.xls	file	Kasp引物设计结果
DeepBSA_DL	folder_2	候选区域引物设计结果（Gprime方法）
DeepBSA_DL.sanger.snp.result.xls	file	常规变异位点引物设计(snp)
DeepBSA_DL.sanger.snp.result.xls	file	常规变异位点引物设计(indel)
DeepBSA_DL.caps.result.xls	file	CAPS引物设计结果
DeepBSA_DL.dcaps.result.xls	file	dCAPS引物设计结果
DeepBSA_DL.kasp.result.xls	file	Kasp引物设计结果
DeepBSA_K	folder_2	候选区域引物设计结果（Gprime方法）
DeepBSA_K.sanger.snp.result.xls	file	常规变异位点引物设计(snp)
DeepBSA_K.sanger.snp.result.xls	file	常规变异位点引物设计(indel)
DeepBSA_K.caps.result.xls	file	CAPS引物设计结果
DeepBSA_K.dcaps.result.xls	file	dCAPS引物设计结果
DeepBSA_K.kasp.result.xls	file	Kasp引物设计结果">> $1/BSA.info.result