...
ED.all.table.xls	file	ED方法定位区域位点和基因详情表
pop.ED.chr*.index.pdf	file	不同染色体上ED方法的曼哈顿图（pdf格式）
pop.ED.chr*.index.png	file	不同染色体上ED方法的曼哈顿图（png格式）
pop.ED.index.pdf	file	ED方法的整体曼哈顿图（pdf格式）
...
Gprime.all.table.xls	file	Gprime方法的整体曼哈顿图（png格式）
Gprime.chr*.index.pdf	file	不同染色体上Gprime方法的曼哈顿图（pdf格式）
Gprime.chr*.index.png	file	不同染色体上Gprime方法的曼哈顿图（png格式）
Gprime.index.pdf	file	Gprime方法的整体曼哈顿图（pdf格式）
