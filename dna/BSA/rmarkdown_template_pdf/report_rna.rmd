...
cat(
  knitr::knit_child('rmd/01.workflow_bsr.rmd', envir = globalenv(), quiet = TRUE)
  )
```
...
cat(
  knitr::knit_child('rmd/01.workflow_pipeline_rna.rmd', envir = globalenv(), quiet = TRUE)
  )
```
...
cat(
  knitr::knit_child('rmd/99.appendix_bsr.rmd', envir = globalenv(), quiet = TRUE)
  )
```
