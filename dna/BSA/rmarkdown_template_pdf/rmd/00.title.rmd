...
project_info <- read.delim('../file/project_info.xls',sep='\t',header=T,check.names = F)
contract_number <- project_info[1, 2]
project_number <- project_info[2, 2]
genome_chinese <- project_info[3, 2]
client_name <- project_info[4, 2]
report_time <- project_info[5, 2]
```
```{r echo=FALSE}
