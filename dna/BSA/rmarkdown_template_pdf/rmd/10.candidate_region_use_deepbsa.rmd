...
>
> *[data_release/06.DeepBSA_DL](./data_release/06.DeepBSA_DL)文件夹下的DeepBSA_DL.all.table.xls（DeepBSA_DL）文件*
>
> *[data_release/07.DeepBSA_K](./data_release/07.DeepBSA_K)文件夹下的DeepBSA_K.all.table.xls（DeepBSA_K）文件*
