...
>
> *[data_release/06.enrich/loess/GO_result](./data_release/06.enrich/loess/GO_result)文件夹下的loess_GOenrichment.xls（SNP-index + loess拟合）文件*
>
> *[data_release/06.enrich/ED/GO_result](./data_release/06.enrich/ED/GO_result)文件夹下的ED_GOenrichment.xls（ED + 滑窗）文件*
>
> *[data_release/06.enrich/Gprime/GO_result](./data_release/06.enrich/Gprime/GO_result)文件夹下的Gprime_GOenrichment.xls（G′ value + 滑窗）文件*
