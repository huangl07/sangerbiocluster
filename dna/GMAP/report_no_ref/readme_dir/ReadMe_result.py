...
if(typeinfo =="BSA_new"):
    os.system(f'''cp {readme_dir}/01.vcf2table_结果说明文档.txt {data_release}/01.vcf2table/ \
        && cp {readme_dir}/02.index_结果说明文档.txt {data_release}/02.index/ \
        && cp {readme_dir}/03.loess_结果说明文档.txt {data_release}/03.loess \
        && cp {readme_dir}/04.ED_结果说明文档.txt {data_release}/04.ED \
        && cp {readme_dir}/05.Gprime_结果说明文档.txt {data_release}/05.Gprime \
        && cp {readme_dir}/06.DeepBSA_DL_结果说明文档.txt {data_release}/06.DeepBSA_DL \
        && cp {readme_dir}/07.DeepBSA_K_结果说明文档.txt {data_release}/07.DeepBSA_K \
        && cp {readme_dir}/08.enrich_结果说明文档.txt  {data_release}/08.enrich \
        && cp {readme_dir}/09.primer_design_结果说明文档.txt  {data_release}/09.primer_design''') 
        
if(typeinfo =="BSA_new_no_use_deepbsa" or typeinfo =="BSR"):
    os.system(f'''cp {readme_dir}/01.vcf2table_结果说明文档.txt {data_release}/01.vcf2table/ \
        && cp {readme_dir}/02.index_结果说明文档.txt {data_release}/02.index/ \
        && cp {readme_dir}/03.loess_结果说明文档.txt {data_release}/03.loess \
        && cp {readme_dir}/04.ED_结果说明文档.txt {data_release}/04.ED \
        && cp {readme_dir}/05.Gprime_结果说明文档.txt {data_release}/05.Gprime \
        && cp {readme_dir}/06.enrich_结果说明文档.txt  {data_release}/06.enrich \
        && cp {readme_dir}/07.primer_design_结果说明文档.txt  {data_release}/07.primer_design''')
if(typeinfo =="GPS"):
