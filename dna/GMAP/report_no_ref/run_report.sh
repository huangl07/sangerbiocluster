...
Rscript ${gmap_path}/report_tmpl/rmarkdown.R --format pdf  --outfile ${output_path}/遗传图谱.pdf --data_release ${output_path} --rmd ${gmap_path}/report_tmpl/report.rmd  --gmap_result ${gmap_result}
Rscript ${gmap_path}/report_tmpl/rmarkdown.R --format html --outfile ${output_path}/遗传图谱.html --data_release ${output_path} --rmd ${gmap_path}/report_tmpl/report.rmd  --gmap_result ${gmap_result}
#示例代码
