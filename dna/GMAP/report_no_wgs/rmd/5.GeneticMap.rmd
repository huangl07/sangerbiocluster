...
```{r get-filter-table}
filtered_stat_file <- file.path(gmap_result_dir, "08.evaluate", "total.filtered.stat")
...
qtl_result <- file.path(gmap_result_dir, "08.evaluate", "total.bin.stat")
...
state_plots <- file.path(gmap_result_dir, "08.evaluate", "total.map.png")
...
```{r get-map-table}
total_mapstat_file <- file.path(gmap_result_dir, "08.evaluate", "total.mapstat")
...
state_plots <- file.path(gmap_result_dir, "08.evaluate", "total.bin.png")
if(!file.exists(state_plots)){state_plots <- file.path(gmap_result_dir, "08.evaluate", "total.sexAver.bin.png")}
if(params$devmode){state_plots <- state_plots[1]}
if(htmlfmt){
    slickR(obj=state_plots,width='95%',height="auto")
} else {
...
state_plots_dir <- file.path(gmap_result_dir, "08.evaluate")
...
state_plots <- file.path(gmap_result_dir, "08.evaluate", "total.phy.png")
if(params$devmode){state_plots <- state_plots[1]}
if(htmlfmt){
    slickR(obj=state_plots,width='95%',height="auto")
} else {
...
total_phy_spearman_file <- file.path(gmap_result_dir, "08.evaluate", "total.phy.spearman.xls")
