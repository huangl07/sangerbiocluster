...
>
> *[data_release/04.qtl/Pm2/GO_result](./data_release/04.qtl/Pm2/GO_result)文件夹下的Pm2_GOenrichment.xls（Pm2性状）文件*
>
> *[data_release/04.qtl/Pm30/GO_result](./data_release/04.qtl/Pm30/GO_result)文件夹下的Pm30_GOenrichment.xls（Pm30性状）文件*
>
> *[data_release/04.qtl/Pm36/GO_result](./data_release/04.qtl/Pm36/GO_result)文件夹下的Pm2_GOenrichment.xls（Pm36性状）文件*
>
> *[data_release/04.qtl/DIR/GO_result](./data_release/04.qtl/DIR/GO_result)文件夹下的DIR_GOenrichment.xls（DIR性状）文件*
...
>
> *[data_release/04.qtl/Pm2/KEGG_result](./data_release/04.qtl/Pm2/KEGG_result)文件夹下的Pm2_KEGGenrichment.xls（Pm2性状）文件*
>
> *[data_release/04.qtl/Pm30/KEGG_result](./data_release/04.qtl/Pm30/KEGG_result)文件夹下的Pm30_KEGGenrichment.xls（Pm30性状）文件*
>
> *[data_release/04.qtl/Pm36/KEGG_result](./data_release/04.qtl/Pm36/KEGG_result)文件夹下的Pm2_KEGGenrichment.xls（Pm36性状）文件*
>
> *[data_release/04.qtl/DIR/KEGG_result](./data_release/04.qtl/DIR/KEGG_result)文件夹下的DIR_KEGGenrichment.xls（DIR性状）文件*
