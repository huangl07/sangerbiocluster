...
open Out,">$fOut.stat";
print Out join("\t","#sampleID","rawreads","rawdata","rawq20","rawq30","rawGC","ada","cleanreads","cleandata","cleanq20","cleanq30","cleanGC","dup"),"\n";
my @out;
push @out,$sample;
