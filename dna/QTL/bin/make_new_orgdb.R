...
###导入GO和KEGG的结果
anno_result <- read.table(opt$annofile, header = TRUE, sep = "\t", col.names = c("transcript_id", "ko_id", "ko_anno", "go_term", "go_anno"),
                          colClasses=c("character", "character", "character", "character", "character"), quote = "")
