...
if(typeinfo =="BSA_new" or typeinfo =="BSR"):
    os.system('''cp readme_dir*/01.vcf2table_readme.txt ./report/Result/data_release/01.vcf2table/ \
        && cp readme_dir*/02.ED_readme.txt ./report/Result/data_release/02.ED/ \
        && cp readme_dir*/03.index_readme.txt ./report/Result/data_release/03.index \
        && cp readme_dir*/04.Gprime_readme.txt ./report/Result/data_release/04.Gprime \
        && cp readme_dir*/05.loess_readme.txt ./report/Result/data_release/05.loess \
        && cp readme_dir*/06.enrich_readme.txt  ./report/Result/data_release/06.enrich''')
if(typeinfo =="GPS"):
