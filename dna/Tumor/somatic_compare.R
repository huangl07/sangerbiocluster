...
merged=left_join(d1,d2,by=c("Chromosome","vcf_pos","HGVSc","Hugo_Symbol")) 
...
merged$pvalue=lapply(1:nrow(merged),myfun,data=merged)
colnames(merged)=c("chr","pos","group1_allele","group2_allele")
print(merged)
